...
/*---------------------------------------------------------------------------*/
#define MSG_PERIOD (30 * CLOCK_SECOND) /* [Lab 7] Non-sink nodes send data packets every ~30 seconds */
#define COLLECT_CHANNEL 0xAA
#define DATA_FORWARDING 1              /* [Lab 7] Set it to 1 to enable data forwarding!!! */ 
/*---------------------------------------------------------------------------*/
